...
#ifndef CBP_FloorFloodFill_hpp
#define CBP_FloorFloodFill_hpp
...
namespace cbpipe {
    ...
    class DLL_LOCAL CBP_FloorFloodFill : public CBP_FloodFillAlgorithm {
        
    public:
        CBP_FloorFloodFill(const cv::Size &gridSize);
        ~CBP_FloorFloodFill();
