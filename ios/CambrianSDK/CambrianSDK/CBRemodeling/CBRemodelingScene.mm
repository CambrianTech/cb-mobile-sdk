...
- (void) generateCoreScene:(NSString *)sceneID {
    self.coreScene = std::shared_ptr<cbscene::CBAR_RemodelingScene>(new cbscene::CBAR_RemodelingScene(self.coreCallback, [sceneID UTF8String], (__bridge void *)self));
}

- (void) generateCoreScene:(NSString *)sceneID rgbaImage:(cv::Mat)rgbaImage {
    self.coreScene = std::shared_ptr<cbscene::CBAR_RemodelingScene>(new cbscene::CBAR_RemodelingScene(self.coreCallback, rgbaImage, [sceneID UTF8String], (__bridge void *)self));
}
