...
static UnityAppController* m_instance;
...
- (void)initUnity:(CGRect)frame {
    ...
    char * FAKE_APP_PATH = (char *) "/var/containers/Bundle/Application/F633A618-8883-4D77-BF07-72DEC26265A6/unity-framework-test.app/unity-framework-test";
    char *argv[1] = {FAKE_APP_PATH};
        ...
        if (_wasPausedExternal == false)
        {
            ...
            if (bgBehavior == appbgSuspend || bgBehavior == appbgExit)
            {
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    if (_snapshotView) {
                        [self.rootView addSubview: _snapshotView];
                    }
