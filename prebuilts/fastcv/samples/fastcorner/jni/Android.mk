...
$(info building sample for $(TARGET_ARCH_ABI)) 
...
LOCAL_LDLIBS += -L/$(FAST_CV_PATH)/inc/lib/$(TARGET_ARCH_ABI)

LOCAL_MODULE    := libfastcvsample
LOCAL_CFLAGS    := -Werror -I$(FAST_CV_PATH)/inc
LOCAL_SRC_FILES := \
    About.cpp \
    FastCVSample.cpp \
    FPSCounter.cpp \
...
LOCAL_C_INCLUDES += -I$(FAST_CV_PATH)/inc
